(function() {
  ...
  const InfoHelpModal = ({ show, onClose, theme }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: t.overlay, onClick: onClose }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Section, { icon: "clock", title: "התראות Push" }, /* @__PURE__ */ React.createElement("p", null, "המערכת יכולה לשלוח התראות כאשר תנאי מזג האוויר משתנים ביום שנבחר."), /* @__PURE__ */ React.createElement("p", null, "הבדיקה מתבצעת כל 30 דקות. התראה נשלחת כאשר הסטטוס משתנה — למשל: רוח עולה מעל הסף, גשם צפוי מתחיל או נעלם, או חלון טיסה חדש נפתח."), /* @__PURE__ */ React.createElement("p", null, "להפעלה: לחצו על כפתור ההתראות בכרטיס היום. הדפדפן יבקש אישור לקבלת התראות."), /* @__PURE__ */ React.createElement("p", null, "לביטול: לחצו שוב על אותו כפתור כדי לבטל מעקב על יום ספציפי."), /* @__PURE__ */ React.createElement("p", null, "ההתראה כוללת: תאריך, טווח שעות, אחוז שעות מתאימות, ונתוני רוח/משבים/גשם מרביים.")),
