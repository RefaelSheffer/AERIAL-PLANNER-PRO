...
(() => {
  ...
  const translations = {
    he: {
      ...
      "notifMgr.changed": "היו {prev} ← {now}",
      "notifMgr.goToLocation": "הצג במפה",

      // === components.js — RealtimePanel ===
      "realtime.title": "זמן אמת",
      "realtime.subtitle": "מכ״ם גשם ומיקומי מטוסים",
      "realtime.description": "הפעלת שכבות מפה מתעדכנות ללא טקסט כפול או עומס מיותר.",
      "realtime.rainRadar": "מכ״ם גשם",
      "realtime.rainRadarSource": "RainViewer · מתעדכן כל 5 דקות",
      "realtime.shown": "מוצג",
      "realtime.hidden": "מוסתר",
      "realtime.radarLoading": "מכ״ם נטען...",
      "realtime.radarUnavailable": "מכ״ם לא זמין",
      "realtime.sourceUnavailable": "מקור הנתונים לא זמין כרגע",
      "realtime.updated": "עודכן:",
      "realtime.hideRain": "הסתר שכבת גשם",
      "realtime.showRain": "הצג שכבת גשם",
      "realtime.active": "פעיל",
      "realtime.off": "כבוי",
      "realtime.refreshRadar": "רענון מכ״ם",
      "realtime.aircraft": "מיקומי מטוסים",
      "realtime.aircraftSource": "ADSBExchange · רענון כל 15 שניות",
      "realtime.connecting": "מתחבר...",
      "realtime.refreshing": "מרענן...",
      "realtime.error": "שגיאה",
      "realtime.range": "טווח:",
      "realtime.kmUnit": 'ק"מ',
      "realtime.inRange": "בטווח",
      "realtime.hideAircraft": "הסתר מיקומי מטוסים",
      "realtime.showAircraft": "הצג מיקומי מטוסים",
      "realtime.searchAroundMap": "חיפוש סביב מרכז המפה",
    ...
    en: {
      ...
      "notifMgr.changed": "was {prev} → now {now}",
      "notifMgr.goToLocation": "Show on map",

      // === components.js — FutureDateTrackingModal ===
      // === components.js — RealtimePanel ===
      "realtime.title": "Real-time",
      "realtime.subtitle": "Rain Radar & Aircraft Positions",
      "realtime.description": "Toggle live map layers without clutter or duplicate text.",
      "realtime.rainRadar": "Rain Radar",
      "realtime.rainRadarSource": "RainViewer · Updates every 5 min",
      "realtime.shown": "Shown",
      "realtime.hidden": "Hidden",
      "realtime.radarLoading": "Radar loading...",
      "realtime.radarUnavailable": "Radar unavailable",
      "realtime.sourceUnavailable": "Data source currently unavailable",
      "realtime.updated": "Updated:",
      "realtime.hideRain": "Hide rain layer",
      "realtime.showRain": "Show rain layer",
      "realtime.active": "Active",
      "realtime.off": "Off",
      "realtime.refreshRadar": "Refresh radar",
      "realtime.aircraft": "Aircraft Positions",
      "realtime.aircraftSource": "ADSBExchange · Refresh every 15 sec",
      "realtime.connecting": "Connecting...",
      "realtime.refreshing": "Refreshing...",
      "realtime.error": "Error",
      "realtime.range": "Range:",
      "realtime.kmUnit": "km",
      "realtime.inRange": "in range",
      "realtime.hideAircraft": "Hide aircraft positions",
      "realtime.showAircraft": "Show aircraft positions",
      "realtime.searchAroundMap": "Search around map center",
